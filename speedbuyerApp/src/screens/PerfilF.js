...
export default class PerfilF extends Component {
  ...
  constructor()
  {
    ...
    componentDidMount()
    {
      ...
      .then(res=>{
        axios.get(`http://arcane-savannah-75129.herokuapp.com/profile/get_pessoa_fisica/${this.state.idUsuario}`)
        .then(res=>{
    ...
    edit = e => {
      this.props.navigation.navigate("PessoaFE", {id:e})
    }
